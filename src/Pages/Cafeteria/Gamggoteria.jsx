// FE2
// GP 감꽃식당 페이지
// src/Pages/Cafeteria/Gamggoteria.jsx
...
const CAFETERIA_ID = "gamggoteria"; // 백엔드에서 쓸 감꽃식당 id
...
function getLastWeekSentence(history) {
  ...
  return `일주일 전 ${timeLabel}에는 감꽃식당이 ${levelLabel}했어요.`;
}

export default function Gamggoteria() {
